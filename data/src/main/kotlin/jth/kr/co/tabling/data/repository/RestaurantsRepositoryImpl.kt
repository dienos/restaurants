...
class RestaurantsRepositoryImpl @Inject constructor(
    ...
    override suspend fun getFavoriteRestaurants(): List<FavoriteRestaurantEntity> = localSource.getFavoriteRestaurants()
    override suspend fun insertFavoriteRestaurant(data: FavoriteRestaurantEntity) = localSource.insertFavoriteRestaurant(data)
    override suspend fun deleteFavoriteRestaurant(restaurantIdx: Int) = localSource.deleteFavoriteRestaurant(restaurantIdx)
